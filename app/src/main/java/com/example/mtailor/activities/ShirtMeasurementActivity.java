...
//                    drop downs
    ...
    private void init() {
        ...
        rootRef = myDB.getReference().child("Users").child(UID).child("Measurements").child(mCustomer.getCustomerID()).child("Shirt");
...
//            Toast.makeText(this, "OK", Toast.LENGTH_SHORT).show();
    ...
    private void createShirt() {
        ...
        shirt = new Shirt(mCustomer.getCustomerID(), strShirtHeight, strShirtChest, strShirtFront,strShirtShoulder,strShirtSleeveRadio, strShirtSleeves, strShirtCollar, strShirtPocket, strShirtType, strShirtNotes);

        rootRef.setValue(shirt).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(ShirtMeasurementActivity.this, "Success!", Toast.LENGTH_SHORT).show();
                } else Toast.makeText(ShirtMeasurementActivity.this, "Failure!", Toast.LENGTH_SHORT).show();
            }
        });
