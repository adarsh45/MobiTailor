...
//        update language of texts
    ...
    private final ValueEventListener offlineDeleteValueEventListener = new ValueEventListener() {
        @Override
    ...
    private final ValueEventListener offlineSaveValueEventListener = new ValueEventListener() {
        @Override
        public void onDataChange(@NonNull DataSnapshot snapshot) {
